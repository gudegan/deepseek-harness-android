window.__ModuleLoader__.load({ id: "dshmarket", factory: (require) => {
		...
		*/
		...
		var Market_module_css_default = {
			...
			"commentsError": "eGUBIq_commentsError",
			"commentsFail": "eGUBIq_commentsFail",
			"commentsLink": "eGUBIq_commentsLink",
			"commentsMount": "eGUBIq_commentsMount",
			"commentsNote": "eGUBIq_commentsNote",
			"commentsStatus": "eGUBIq_commentsStatus",
			...
			"noteAction": "eGUBIq_noteAction",
			"noteEdit": "eGUBIq_noteEdit",
			"noteInput": "eGUBIq_noteInput",
			"noteMine": "eGUBIq_noteMine",
			"noteRow": "eGUBIq_noteRow",
			"notesArrow": "eGUBIq_notesArrow",
			"notesBody": "eGUBIq_notesBody",
			"notesCode": "eGUBIq_notesCode",
			"notesDate": "eGUBIq_notesDate",
			"notesH": "eGUBIq_notesH",
			"notesLink": "eGUBIq_notesLink",
			"notesList": "eGUBIq_notesList",
			"notesMeta": "eGUBIq_notesMeta",
			"notesMsg": "eGUBIq_notesMsg",
			"notesP": "eGUBIq_notesP",
			"notesPre": "eGUBIq_notesPre",
			"notesRange": "eGUBIq_notesRange",
			"notesRendered": "eGUBIq_notesRendered",
			"notesRow": "eGUBIq_notesRow",
			"notesSha": "eGUBIq_notesSha",
			"notesVer": "eGUBIq_notesVer",
